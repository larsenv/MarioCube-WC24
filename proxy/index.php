...
<head>
  ...
  <SCRIPT language="JavaScript" src="/en_US/js//keyboard.js"></SCRIPT>
</head>
<body>
<div id="container">
  <div id="menu">
...
else
{
  ...
  <tr><td class="option" style="width: 20%">URL</td><td class="option" style="width: 80%">&nbsp;<input type="text" name="url" size="70" value="" onmousedown="kbd.call(0);" /></td></tr>
