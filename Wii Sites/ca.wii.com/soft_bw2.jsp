	...
	<div align="center">
		<div class="content">
			...
			<div class="title_bar">
				...
				<img src="images/games/bw2/title.gif" />
			</div>
			
			<div class="software_hero" style="background-image:url(images/games/bw2/hero.jpg);">
				<div class="software_info" style="margin-top:30px;">
				  <span class="release_date" >
				  <br /><br />
				   29.10.2007 | <span class="gameDate_Plyrs">Joueurs</span>: 1-2<br />
				  </span>
					<p>
					Forc&eacute;s de croire que le Solar Empire est en train de d&eacute;velopper une super arme d&eacute;vastatrice, Commander Pierce et Colonel Windsor d'Ango Isles d&eacute;clarent guerre aux Coral Atolls. Le monde vit un conflit une fois de plus. Ce jeu conna&icirc;t un d&eacute;but explosif sur la Wii gr&acirc;ce &agrave; ses nouvelles unit&eacute;s navales, ses nouveaux v&eacute;hicules et des tonnes de missions. <span class="other_info">
					<strong>Publisher</strong>: Nintendo
					</span>
					</p>
					<a href="http://wii.nintendo.com/site/battalionwars2"><img src="images/software/game_pg/more_info_off.gif" onmouseover="this.src='images/software/game_pg/more_info_on.gif'" onmouseout="this.src='images/software/game_pg/more_info_off.gif'" alt="More Info..." /></a>
					<div class="esrbRating"><a href="http://www.esrb.org"><img src="images/common/esrb_T_violence.gif" alt="ESRB Rating" /></a></div>
			  </div>
			</div>
...
s.pageName="ca:wii:software:batallion wars 2:home" /* Page Name */
s.channel="ca:wii:wii" /* Platform */
s.prop1="ca:wii:batallion wars 2" /* Product */
s.prop2="game:details" /* Content Type */
s.prop10="batallion wars 2" /* Game Title */
