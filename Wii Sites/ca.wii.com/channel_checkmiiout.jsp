...
<div id="gametitlebar">
  ...
  <div id="gameArtcheckmiiout">  
  <div id="gameInfo"><table width="260" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top"><img src="images/software/game_pg/logo/logo_checkmiiout_channel.jpg" width="170" height="100"></td>
  </tr>
  <tr>
    <td valign="top"><p>Sur la Chaîne Regardez-Mii, vous pouvez présenter, échanger ou simplement regarder les Mii affichés par d'autres personnes. Ou, la section de concours de la Chaîne Regardez-Mii lance un défi aux utilisateurs de présenter leurs créations de Mii qui correspondent à une personne, un personnage ou un thème spécifique. Les utilisateurs peuvent ensuite voter pour les Mii ayant été soumis par d'autres personnes afin de déterminer le Mii qui représente le mieux le défi.</p>
      </td>
  </tr>
    <tr>
    <td valign="top"><a href="viewer_channel.jsp?vid=7"><img src="images/video/view_mii_vid.gif" width="200" height="23" border="0" /></a></td>
  </tr>
</table>
  </div>
  </div>
<a href="story_miicontest.jsp"><div id="dev_banner_photo" style="background-image:url(images/features/story/checkmiiout/story_banner.jpg)"></div></a>
...
s.pageName="ca:wii:channel:checkmiioutchannel" /* Page Name */
s.channel="ca:wii:wii" /* Platform */
s.prop1="ca:wii:check mii out channel" /* Product */
s.prop2="game:details" /* Content Type */
s.prop10="check mii out channel" /* Game Title */
