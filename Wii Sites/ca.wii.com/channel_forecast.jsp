...
<div id="gametitlebar">
  ...
  <div id="gameArtforecast">  
  <div id="gameInfo"><table width="260" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top"><img src="images/software/game_pg/logo/logo_forecast_channel.gif" width="170" height="100"></td>
  </tr>
  <tr>
    <td valign="top"><p> Les utilisateurs peuvent acc&eacute;der gratuitement aux pr&eacute;visions m&eacute;t&eacute;o lorsqu'ils allument la console Wii. Lorsque connect&eacute;e &agrave; l'Internet, la Wii mettra &agrave; jour automatiquement les informations m&eacute;t&eacute;orologiques de la r&eacute;gion et du monde. Utilisez la t&eacute;l&eacute;commande Wii pour tourner le globe et pour consulter les rapports m&eacute;t&eacute;o de votre ville ou de partout sur la plan&egrave;te ! *Cette cha&icirc;ne peut seulement &ecirc;tre acc&eacute;d&eacute;e lorsque la console Wii est connect&eacute;e &agrave; Internet.</p>
      </td>
  </tr>
    <tr>
    <td valign="top"><a href="viewer_channel.jsp?vid=3"><img src="images/features/channels/view_news_vid.gif" width="200" height="23" border="0" /></a></td>
  </tr>
</table>
  </div>
  </div>
  ...
  <dl><dt><a href="story_forecast.jsp"><img src="images/features/story/forecast/story_banner.jpg" width="780" height="111" border="0" /></a>
    <p></p>
...
s.pageName="ca:wii:channel:forecastchannel" /* Page Name */
s.channel="ca:wii:wii" /* Platform */
s.prop1="ca:wii:forecast channel" /* Product */
s.prop2="game:details" /* Content Type */
s.prop10="forecast channel" /* Game Title */
