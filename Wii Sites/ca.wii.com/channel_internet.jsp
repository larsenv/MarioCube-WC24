...
<div id="gametitlebar">
  ...
  <tr>
    <td valign="top"><img src="images/features/title/title_wii_channel_lrg.gif" width="680" height="33" /></td>
  ...
  <div id="gameArtnews" style="background-image:url(images/software/game_pg/characters/bg_internet.jpg);">  
  <div id="gameInfo"><table width="260" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top"><img src="images/software/game_pg/logo/logo_internet_channel.gif"></td>
  </tr>
  <tr>
    <td valign="top"><p><span class="videoCaptionReg">Cette cha&icirc;ne change de fa&ccedil;on dramatique le lien qui existe entre l'utilisateur &agrave; la maison, le t&eacute;l&eacute;viseur et l'Internet. Les utilisateurs t&eacute;l&eacute;chargent le navigateur Opera avec des points Wii. Ensuite, ils peuvent surfer sur l'Internet dans le confort de leur salon. La cha&icirc;ne Internet peut &ecirc;tre t&eacute;l&eacute;charg&eacute;e au co&ucirc;t de 500 points Wii.<br />
*Cette cha&icirc;ne peut seulement &ecirc;tre acc&eacute;d&eacute;e lorsque la console est connect&eacute;e &agrave; Internet. </span></p>
      </td>
  </tr>
    <tr>
    <td valign="top"><a href="viewer_channel.jsp?vid=1"><img src="images/video/view_mii_vid.gif" width="200" height="23" border="0" /></a></td>
  </tr>
</table>
  </div>
  </div>
  ...
  <dl><dt><a href="story_internet.jsp"><img src="images/features/story/internet/story_banner.jpg" width="780" height="111" border="0" /></a>
    <p></p>
  
  <a href="javascript:history.go(-1)" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image22','','images/common/back_on.gif',1)"><img src="images/common/back_off.gif" alt="pr&eacute;c&eacute;dent" name="Image22" width="65" height="10" border="0" id="Image22" /></a>
...
s.pageName="ca:wii:channel:internetchannel" /* Page Name */
s.channel="ca:wii:wii" /* Platform */
s.prop1="ca:wii:internet channel" /* Product */
s.prop2="game:details" /* Content Type */
s.prop10="internet channel" /* Game Title */
