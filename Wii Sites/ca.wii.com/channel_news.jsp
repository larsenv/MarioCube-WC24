...
<div id="gametitlebar">
  ...
  <tr>
    <td align="center" valign="top"><img src="images/software/game_pg/logo/logo_news_channel.gif" width="170" height="100"></td>
  </tr>
  <tr>
    <td valign="top"><p>Regardez les nouvelles, m&ecirc;me par un matin occup&eacute;. En utilisant la cha&icirc;ne infos, vous pouvez choisir les articles de nouvelles que vous voulez lire &agrave; partir d'une liste de titres tr&egrave;s facile &agrave; parcourir. * La cha&icirc;ne ne peut &ecirc;tre acc&eacute;d&eacute;e que lorsque la console Wii est connect&eacute;e &agrave; l'Internet. Le contenu de cette vid&eacute;o contient des aper&ccedil;us d'histoires de nouvelles capt&eacute;es en janvier 2007.</p>
      </td>
  </tr>
    <tr>
    <td valign="top"><a href="viewer_channel.jsp?vid=2"><img src="images/video/view_mii_vid.gif" width="200" height="23" border="0" /></a></td>
  </tr>
</table>
  </div>
  </div>
  ...
  <dl><dt><a href="story_home.jsp"><img src="images/features/story/story_banner.jpg" width="780" height="111" border="0" /></a>
    <p></p>
...
s.pageName="ca:wii:channel:newschannel" /* Page Name */
s.channel="ca:wii:wii" /* Platform */
s.prop1="ca:wii:news channel" /* Product */
s.prop2="game:details" /* Content Type */
s.prop10="news channel" /* Game Title */
