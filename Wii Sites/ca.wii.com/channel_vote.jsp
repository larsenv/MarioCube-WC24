...
<div id="gametitlebar">
  ...
  <div id="gameArtvote">  
  <div id="gameInfo"><table width="300" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top"><img src="images/software/game_pg/logo/logo_vote_channel.gif"></td>
  </tr>
  <tr>
    <td valign="top"><p>Gr&acirc;ce &agrave; la cha&icirc;ne tout le monde vote, vous pourrez r&eacute;pondre &agrave; des questions populaires comme celle plus haut et donner votre opinion dans des sondages nationaux et mondiaux. Voter est facile pour tous les membres de la famille. Choisissez simplement la question &agrave; laquelle vous voulez r&eacute;pondre et s&eacute;lectionnez une des deux r&eacute;ponses. Ensuite, revenez consulter les r&eacute;sultats. Vous pouvez m&ecirc;me pr&eacute;dire quelle r&eacute;ponse obtiendra le plus de votes et d&eacute;couvrir la diff&eacute;rence entre vos pr&eacute;dictions et celles des autres personnes dans la nation.<br />
    *Cette cha&icirc;ne peut seulement &ecirc;tre acc&eacute;d&eacute;e lorsque la console Wii est connect&eacute;e &agrave; Internet.<br />
    *La Cha&icirc;ne votes peut &ecirc;tre t&eacute;l&eacute;charg&eacute;e sur la Cha&icirc;ne Boutique Wii<br />
    *Un maximum de 6 personnes peuvent jouer sur la Cha&icirc;ne votes</p>
      </td>
  </tr>
    <tr>
    <td valign="top"><a href="viewer_channel.jsp?vid=7"></a></td>
  </tr>
</table>
  </div>
  </div>
  ...
  <dl><dt><a href="story_vote.jsp"><img src="images/features/story/vote/story_banner.jpg" width="780" height="129" border="0" /></a>
    <p></p>
...
s.pageName="ca:wii:channel:everybodyvoteschannel" /* Page Name */
s.channel="ca:wii:wii" /* Platform */
s.prop1="ca:wii:everybody votes channel" /* Product */
s.prop2="game:details" /* Content Type */
s.prop10="everybody votes channel" /* Game Title */
